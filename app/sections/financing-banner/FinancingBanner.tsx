...
/>
        ...
        <div className="text-center md:text-left">
          <h2 className={`${playfair.className} text-2xl md:text-3xl font-normal text-black leading-snug`}>
            <em className="font-semibold">Limited-Time</em> 18-Month Special Financing †
          </h2>
          <p className="mt-3 text-sm md:text-base text-gray-700 leading-relaxed">
            Enjoy convenient monthly payments and exclusive special financing with the new
            Oregon Co Credit Card, powered by Synchrony Bank.
          </p>
          <button
            onClick={() => {}}

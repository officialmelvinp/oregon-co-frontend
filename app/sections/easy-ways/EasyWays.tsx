...
const options = [
  ...
  { text: "Chat Now", extra: "with a Friendly Jewelry Expert", link: true },
  {
    ...
    extra: ", No Appointment Necessary",
    link: true,
  },
];
    ...
    <section className="bg-white text-black">
      <div className="max-w-[1400px] mx-auto flex flex-col md:flex-row">
        ...
        <div className="w-full md:w-1/2 flex flex-col justify-center px-8 md:px-16 py-12 md:py-0">
          <h2
            className={`${playfair.className} text-3xl md:text-4xl font-normal text-black leading-snug`}
          >
            <em className="font-semibold">Easy Ways</em> to
            <br />
            Shop Oregon Co.
          </h2>
          ...
          <ul className="mt-6 space-y-3">
            {options.map((opt, i) => (
              <li
                key={i}
                className="flex items-start gap-2 text-sm md:text-base text-gray-800"
              >

...
const products = [
  {
    title: "Sapphire Petals Engagement Ring",
    price: 1775,
    note: "Center Stone Sold Separately",
    img: "/products/a.png",
  },
  {
    title: "Chantal Engagement Ring (0.40 tcw Diamond)",
    price: 1950,
    note: "Center Stone Sold Separately",
    img: "/products/b.png",
  },
  {
    title: "Woodland Wedding Set",
    price: 2440,
    note: "Center Stone Sold Separately",
    img: "/products/c.png",
  },
  {
    title: "Cypress Halo Engagement Ring",
    price: 4175,
    note: "Center Stone Sold Separately",
    img: "/products/d.png",
  },
  {
    title: "Marseille Cathedral Engagement Ring",
    price: 4405,
    note: "Center Stone Sold Separately",
    img: "/products/e.png",
  },
  ...
  {
    title: "Vintage Milgrain Solitaire Ring",
    price: 1850,
    note: "Center Stone Sold Separately",
    img: "/products/l.png",
  },
    ...
    <section className="py-12 bg-white text-black">
      <div className="max-w-[1400px] mx-auto px-4 md:px-6">
        ...
        <div className="flex justify-between items-start mb-2">
          <div>
            <h2
              className={`${playfair.className} text-2xl md:text-3xl font-normal text-black`}
            >
              ...
              <div key={idx} className="px-2">
                ...
                >
                  ...
                  <div className="mt-3 px-0.5">
                    <p
                      className={`${playfair.className} text-sm font-normal text-gray-800 leading-snug line-clamp-2 min-h-[40px]`}
                    >
                      {item.title}
                    </p>
